...
ModelServerSettHelper::ModelServerSettHelper(const std::string &sGroup, const std::string &sName, QString sValue, bool bPassword)
...
ModelServerSettHelper::ModelServerSettHelper(const std::string &sGroup, const std::string &sName, bool bValue)
    : ModelServerSettHelper() {
    m_sName = sName;
...
ModelServerSettHelper::ModelServerSettHelper(const std::string &sGroup, const std::string &sName, int nValue)
    : ModelServerSettHelper() {
    m_sName = sName;
