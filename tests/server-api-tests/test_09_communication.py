...
#       read_out_3['messages'][-1]['message'], send_out_1['message'])
#     fhqtest.check_values("sended message",
#       read_out_2['messages'][-1]['message'], send_out_1['message'])
...
#     fhqtest.alert(read_out_3['messages'][-1]['message'] == edit_out_2['message'],
...
#     fhqtest.check_values("edited message", read_out_1['messages'][-1]['message'],
#           edit_out_2['message'])
