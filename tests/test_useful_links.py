...
try:
    ...
    url1 = fhqtest.generate_random(255)
    description1 = fhqtest.generate_random(300)
    author1 = fhqtest.generate_random(255)
    ...
    if ul_add['result'] == 'FAIL':
        raise ValueError('Could not create Useful Link')
