...
def run_tests():
    ...
    fhqtest.alert(r_event1 is None, 'Could not get response (getpublicevent)')
    ...
    fhqtest.alert(r_event1_removed is None, 'Could not get response (deletepublicevent)')
