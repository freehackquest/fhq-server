    ...
    for (; it!=g_pCmdHandlers->end(); ++it) {
        ...
        if (sCmd.find(".") != std::string::npos) {
            ...
            if (std::find(vStringGroups.begin(), vStringGroups.end(), sGroup) == vStringGroups.end()) {
                ...
                // builder.add("from freehackquest_libclient_py.FreeHackQuestApi"  + sGroup + " import FreeHackQuestApi" + sGroup);
            }
        }
    }
...
void ExportLibWsjCppCliPy::export__init__py() {
    ...
    std::cout << " * write code to freehackquest-libclient-py/freehackquest_libclient_py/__init__.py " << std::endl;
    ...
    .add("# -*- coding: utf-8 -*-")
    .add("# Copyright (c) 2020-2021 FreeHackQuest Team <freehackquest@gmail.com>")
    .add("\"\"\"This file was automatically generated by fhq-server")
    .add("Version: " + std::string(WSJCPP_APP_VERSION))
    .add("Date: " + m_sCurrentDate)
    .add("\"\"\"")
    .add("from freehackquest_libclient_py.freehackquest_client import FreeHackQuestClient")
    ;
...
void ExportLibWsjCppCliPy::exportApiGroupsPy() {
    for (int i = 0; i < m_vGroups.size(); i++) {
        ...
        std::cout << " * write code to freehackquest-libclient-py/freehackquest_libclient_py/" << sFilename << ".py " << std::endl;
...
void ExportLibWsjCppCliPy::exportClientPy() {
    ...
    std::cout << " * write code to freehackquest-libclient-py/freehackquest_libclient_py/freehackquest_client.py " << std::endl;
    freeHackQuestClientPy.open ("freehackquest-libclient-py/freehackquest_libclient_py/freehackquest_client.py");
