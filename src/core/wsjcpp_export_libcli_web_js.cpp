...
void ExportLibCliWebJS::exportLibCliWebJSFile(const std::string &sBasicDir) {
    ...
    libwjscppcli_web_js_file <<
        "// This file was automatically generated by " << m_sAppName << " (v" + m_sAppVersion + "), date: " << m_sCurrentDate << "\r\n"
        "window." << m_sLibraryName << " = window." << m_sLibraryName << " || (function() { \r\n"
        "    var self = {};\r\n"
        "    self.appName = '" + m_sAppName + "';\r\n"
        "    self.appVersion = '" + m_sAppVersion + "';\r\n"
        "    self.appBuildDate = '" + m_sCurrentDate + "';\r\n"
        "    var _lastm = 0;\r\n"
        "    var _listeners = {};\r\n"
...
void ExportLibCliWebJS::exportLibCliWebServiceTSFile(const std::string &sBasicDir) {
    ...
    libwjscppcli_web_service_ts_file <<
        "// This file was automatically generated by " << m_sAppName << " (" + m_sAppVersion + "), date: " << m_sCurrentDate << "\r\n"
        ...
        "  private appBuildDate: string = '" + m_sCurrentDate + "';\r\n"
    ...
    for (; it!=g_pCmdHandlers->end(); ++it) {
        ...
        libwjscppcli_web_service_ts_file <<
            "  " << sCmd << "(value: Object): Observable<any> {\r\n";
        ...
        if (sCmd == "login") {
            ...
            libwjscppcli_web_service_ts_file 
                << "    return this.wsRequest('" << sCmd << "', value);\r\n\r\n";
        }
