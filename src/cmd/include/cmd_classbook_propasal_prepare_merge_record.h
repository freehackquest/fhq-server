#ifndef CMD_CLASSBOOK_PROPASAL_PREPARE_MERGE_RECORD_H
#define CMD_CLASSBOOK_PROPASAL_PREPARE_MERGE_RECORD_H
...
#endif // CMD_CLASSBOOK_PROPASAL_PREPARE_MERGE_RECORD_H
